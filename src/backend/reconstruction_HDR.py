...
class ReconstructionHDR(image_handler.ImageHandler):
    """
    ...
    def __init__(self, images=None, color=True):
        """
        Constructs a new instance of the ReconstructionHDR object.
    ...
    def update_images(self, images):
        ...
        """
        self.handler = hdr_image_handler.hdr_handler(images=[image_handler.ImageHandler(i) for i in images])

    def fit(self, epochs=1) -> ReconstructionHDR:
        """
