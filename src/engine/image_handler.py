...
class ImageHandler:
    ...
    def change_photo(self, path) -> list:
        """
    ...
    def verify_integrity(self):
        """
        Make sure that the image is in the correct interval
        """
        assert 0 <= self.data.max() <= 1, "data is out of the correct interval [0, 1]"
        assert 0 <= self.data.min() <= 1, "data is out of the correct interval [0, 1]"
    ...
    def convert_Grayscale(self, data=None) -> Array:
        """
    ...
    def normalize(self, data=None) -> Array:
        """
