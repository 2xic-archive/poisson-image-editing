...
class grayscale_window(App):
	def __init__(self, parent=None):	
		App.__init__(self)
		self.grayscale = grayscale.grayscale(self.image)
		self.method = self.grayscale
	...
	def initUI(self):
		...
		#self.pixmap = pil2pixmap(Image.fromarray(255 * self.grayscale.data))
		self.pixmap = pil2pixmap(Image.fromarray((self.grayscale.data * 255).astype(np.uint8)))
