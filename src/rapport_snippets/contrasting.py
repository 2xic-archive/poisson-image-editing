...
def compile(output_dir="./rapport_snippets/output/"):
	...
	results_doc = compile_doc(contrast_obj, epoch_count, output_path=output_dir, path_latex="kontrastforsterkning/contrast/")
...
def compile_color(output_dir):
	...
	results_doc = compile_doc(contrast_obj, epoch_count, output_path=output_dir, path_latex="kontrastforsterkning/contrast_2/")
	results_doc.save("{}/results.tex".format(output_dir))
	intensity(output_dir, contrast_obj, epochs=10)
